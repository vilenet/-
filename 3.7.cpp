/**************************************************************************
 1. Ќайти номер максимального элемента массива.
 2. Ќайти произведение элементов массива, расположенных между первым и вто-
    рым нулевыми элементами.
 3. ѕреобразовать массив таким образом, чтобы в первой его половине располага-
    лись элементы, сто€вшие в нечетных позици€х, а во второй половине Ч элементы,
    сто€вшие в четных позици€х.
**************************************************************************/
...
int main()
{
    ...
    // дл€ 3 услови€, создадим массив в котором элементы будут соответствовать индексам
